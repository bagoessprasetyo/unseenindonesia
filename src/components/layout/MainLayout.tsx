    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex h-16 justify-between items-center">
            ...
            <div className="hidden md:flex flex-1 max-w-lg mx-8">
              <div className="relative w-full">
                ...
                <input
                  type="text"
                  className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-indonesia-red focus:border-indonesia-red"
      ...
      {user && (
        <button
          ...
          className="fixed bottom-6 right-6 w-14 h-14 bg-indonesia-red text-white rounded-full shadow-lg hover:bg-indonesia-deep-red transition-all duration-200 transform hover:scale-105 flex items-center justify-center z-40 animate-pulse"
